init = function() {
  ...
  loadingText = currentLang == 'en' ? 'Loading next ads…' : 'Chargement des annonces suivantes…'
  ...
  var listingOnNewContent = function() {
